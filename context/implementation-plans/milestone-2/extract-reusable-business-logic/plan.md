...
| 5+ | Hardware modules, cheapest first: `Peripherals/` (UI references in one file of 41), then `USB/`, `Battery/`, `Fan/`, `Display/`, `Gpu/`, the rest of `Mode/`, `AnimeMatrix/`, `Ally/`, `Input/` | Not started |
